...
const WORDS = ["Front-End Developer", "Back-End Developer"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind", "Laravel", "Python", "FastAPI", "Flask", "PostgreSQL", "SQL"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/SpimJO" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/jechocanlas15/" },
  { icon: Instagram, link: "https://www.instagram.com/capt.jecho" }
];
